...
export const StickyCTA = () => {
  ...
  return <div className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-background/80 backdrop-blur-lg border-t border-border animate-slide-up">
      <div className="container max-w-4xl mx-auto flex items-center justify-between gap-4">
        <div className="hidden sm:block">
          ...
          <p className="font-poppins font-bold text-accent">Apenas R$37,90</p>
        </div>
        <Button onClick={scrollToOffer} size="lg" className="flex-1 sm:flex-none bg-primary hover:bg-primary/90 text-primary-foreground font-poppins font-semibold box-glow">
