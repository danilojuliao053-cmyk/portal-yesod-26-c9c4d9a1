...
const benefits = [
  '26 protocolos de reprogramação em áudio',
  'Acesso imediato após a compra',
  'Guia de acompanhamento da jornada',
  'Suporte durante os 26 dias',
  'Acesso vitalício ao conteúdo',
];

export const OfferSection = () => {
  return (
    <section id="offer" className="py-20 px-4 gradient-mystic">
        ...
        <div className="bg-card border-2 border-primary/50 rounded-2xl p-8 md:p-12 space-y-8 box-glow">
          ...
          <div className="text-center space-y-4 pt-4">
            <div className="space-y-1">
              ...
              <p className="text-5xl font-poppins font-bold text-accent text-glow-gold">
                R$9,90
              </p>
            ...
            <Button 
              size="lg" 
              className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-poppins font-semibold text-lg py-6 box-glow"
            >
