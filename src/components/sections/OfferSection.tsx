...
const benefits = [
  '26 áudios liberados diariamente',
...
export const OfferSection = () => {
  ...
  return (
    <section ref={sectionRef} id="offer" className="py-20 px-4 gradient-mystic">
      <div 
      ...
      >
        <div className="bg-card border-2 border-primary/50 rounded-2xl p-8 md:p-12 space-y-8 box-glow">
          <div className="text-center space-y-4">
            <p className="text-primary font-medium tracking-wide uppercase text-sm">Investimento</p>
          ...
          <div className="text-center space-y-4 pt-4">
            <div className="space-y-1">
              <p className="text-5xl font-poppins font-bold text-accent text-glow-gold">R$37</p>
            </div>
